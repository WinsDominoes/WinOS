...
; Data section
	...
	txt_title_msg	db 'WinOS Text Editor', 0
	...
	file_load_fail_msg	db '[WinOS] Could not load file! Does it exist?', 0
	new_file_msg		db '[WinOS] Enter a new filename:', 0
	file_save_fail_msg1	db '[WinOS] Could not save file!', 0
	file_save_fail_msg2	db '[WinOS] (Write-only media or bad filename?)', 0
	file_save_succeed_msg	db '[WinOS] File saved.', 0

...
option_screen:
	...
	os_init_msg		db 'Welcome to WinOS - A very basic operating system ', 0
	os_version_msg		db 'Version ', MIKEOS_VER, 0

	dialog_string_1		db 'Thanks for trying out WinOS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'WinOS: Cannot load and execute WinOS', 0
	kerndlg_string_2	db 'kernel! KERNEL.BIN is the core of WinOS,', 0
	kerndlg_string_3	db 'and is not a normal program.', 0

	ext_string_1		db 'WinOS: Invalid filename extension! You', 0
	ext_string_2		db 'can only execute .BIN or .BAS programs.', 0

	program_finished_msg	db '-----------', 13, 10, '|  WinOS  |', 13, 10, '-----------', 13, 10, 'Program finished running... Press any key to continue', 0

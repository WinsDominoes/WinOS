...
.esc_pressed:				; Set carry flag if Escape was pressed
	...
	.help_msg1	db '[WinOS] Please select a file using the', 0
	.help_msg2	db 'cursor keys from the list below...', 0
...
.two_button_wait:
	...
	mov bl, 00001111b		; White on red for cancel button
	mov dh, 14
	mov dl, 42
	mov si, 9
	mov di, 15
...
.noleft:
	...
	mov bl, 00001111b		; Black on white
	mov dh, 14
	mov dl, 27
	mov si, 8
	mov di, 15
